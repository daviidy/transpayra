        ...
        <div className="max-w-3xl mx-auto px-4 py-20 text-center">
          ...
          <div className="bg-white rounded-xl shadow-md p-8 mb-12">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div>
                <p className="text-3xl font-bold text-blue-600 mb-2">300,000+</p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            ...
            <Link
              href="/"
              className="inline-block px-8 py-4 bg-white text-blue-600 font-semibold rounded-lg border-2 border-blue-600 hover:bg-blue-50 transition-colors"
            >
              Explore Salaries
            </Link>
          </div>
